...
* Five _lower ring_ vertexes, forming a regular pentagon at latitude $$-\arctan(1/2)$$ (indexes $$7$$ to $$11$$). The longitude angles are shifted so each lower ring vertex is between two upper ring vertexes. Thus, they can be generated by using longitude angles $$2\pi\,(i+1/2)/5$$, for each $$i$$ from $$0$$ to $$4$$.
