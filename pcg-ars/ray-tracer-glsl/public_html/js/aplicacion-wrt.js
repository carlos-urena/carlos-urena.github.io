import { Log, ComprErrorGL, Assert, EstadoRaton, Cuadrado } from "./utilidades.js";
import { CrearCauce } from "./cauce.js";
import { Vec3, Vec3DesdeColorHex } from "./vec-mat.js";
import { Textura } from "./texturas.js";
import { CrearInputCheckbox, CrearInputColor, CrearInputSlider, CrearInputSliderEntero, CrearElementoSpanTexto } from "./controles.js";
// -------------------------------------------------------------------
/**
...
export class AplicacionWRT {
    ...
    tipo_webgl = "no calculado";
    // nombre de la GPU y del fabircante de la gpu 
    // (inicializado en obtenerContextoWebGL)
    gpu_modelo = "no calculado";
    gpu_fabricante = "no calculado";
    // elemento span con el nombre del modelo de GPU
    texto_gpu_modelo = null;
    // -------------------------------------------------------------------------
    /**
     ...
     */
    constructor() {
        const nombref = "AplicacionWRT.constructor:";
     ...
     */
    async inicializar() {
        const nombref = "AplicacionWRT.inicializar:";
    ...
    crearCheckboxIluminacion() {
        const nombref = 'AplicacionWRT.crearCheckboxIluminacion';
    ...
    crearElementosControles() {
        const nombref = 'AplicacionWRT.crearElementosControles:';
    ...
    redimensionarVisualizar() {
        const nombref = "AplicacionWRT.redimensionarVisualizar:";
        if (this.canvas == null) {
    ...
    obtenerElementoContenedor(id_contenedor) {
        const nombref = "AplicacionWRT.obtenerElementoContenedor:";
    ...
    obtenerCrearElementoCanvas(contenedor) {
        const nombref = "AplicacionWRT.obtenerCrearElementoCanvas:";
        let canvas = null;
    ...
    obtenerContextoWebGL(canvas) {
        const nombref = "AplicacionWRT.obtenerContextoWebGL:";
    ...
    fgeRatonRueda(e) {
        ...
        const delta = e.deltaY / 120.0;
        const d = this.cam_dist;
        const mind = 0.1;
