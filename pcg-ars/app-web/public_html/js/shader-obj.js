...
export class ShaderObject {
    tipo_shader; // tipo de shader (gl.VERTEX_SHADER o gl.FRAGMENT_SHADER)
    url_fuente; // url del archivo con el fuente del shader
    texto_fuente; // texto fuente del shader
    gl; // contexto usado para crear este shader
    descripcion_fuente; // descripción de la fuente (URL del archivo o "cadena de texto")
    shader_object = null; // objeto shader encapsulado
    // --------------------------------------------------------------------------------------------
    /**
     ...
     */
    constructor(gl, tipo_shader, url_fuente, texto_fuente) {
        const nombref = "ShaderObject.constructor:";
     ...
     * @returns
     */
    static crearDesdeTexto(gl, tipo_shader, texto_fuente) {
        const nombref = "ShaderObject.crearDesdeTexto:";
     ...
     */
    compilar() {
        const nombref = "ShaderObject.compilar:";
