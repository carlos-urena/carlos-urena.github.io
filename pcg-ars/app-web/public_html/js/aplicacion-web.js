...
export class AplicacionWeb {
    ...
    async crearObjetosCamaras() {
        ...
        this.camaras.push(new CamaraOrbital3D());
        this.objetos.push(new GrafoTest2(await Textura.crear("uv-checker-1.png"), await Textura.crear("uv-checker-2.png"), await Textura.crear("uv-checker-1.png")));
        this.camaras.push(new CamaraOrbital3D());
        ...
        this.camaras.push(new CamaraOrbital3D());
        this.objetos.push(new OC_GrafoTest2(await Textura.crear("uv-checker-1.png"), await Textura.crear("uv-checker-2.png"), await Textura.crear("uv-checker-1.png")));
        this.camaras.push(new CamaraOrbital3D());
